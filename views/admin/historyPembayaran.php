                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between">
                            ...
                            if(isset($_POST['nisn']) && $_POST['nisn'] != ''): 
                               ...
                               ?>
                                <a href="generateLaporanSiswa.php?nisn=<?= $siswa['nisn'] ?>" target="_BLANK" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Cetak History</a>
                            <?php
                                endforeach;
                            else: 
                            ?>
                                <a href="generateLaporan.php" target="_BLANK" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
